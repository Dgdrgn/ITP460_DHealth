...
<script>
    ...
    var buyerData = {
        ...
        datasets : [
            {
                fillColor : "rgba(9,53,90,.7)", //dark blue
                strokeColor : "rgba(233,130,51,1)", //orange
                pointColor : "rgba(15,119,170,1)", //light blue
    ...
    // draw line chart
    new Chart(buyers).Line(buyerData,  {pointDotStrokeWidth : 2, pointDotRadius : 6} );
